...
# genai.configure(api_key="AIzaSyCseuVyCzYhWbF6ECbWuueBBmey5eHDH60")
...
#         if not match:
#             raise ValueError(f"No JSON found in Gemini output: {raw_text}")
...
#         # Safer extraction (doesn't rely on response.text)
#         if not response.candidates:
#             raise ValueError("No candidates returned by Gemini")
